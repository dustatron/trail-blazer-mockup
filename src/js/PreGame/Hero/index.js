    ...
    <main className='flex-container'>
      <div className='main-content red'>
        <div className='teamLogos'>
          <img
            className='blazersLogo'
            id='blazersLogo'
            src='https://publish.nba.com/blazers/sites/blazers/files/blazers.png'
            alt='team logo'
          />
          <img
            className='awayLogo'
            id='awayLogo'
            src='https://publish.nba.com/blazers/sites/blazers/files/pelicans.png'
            alt='team logo'
          />
        </div>
